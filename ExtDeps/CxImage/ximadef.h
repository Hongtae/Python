...
#ifndef CX_PI
 #define CX_PI 3.141592653589793f
#endif
...
// Modified: change UNICODE macros to use without proj settings (by tiff, 2013-05-21)
#ifdef _WIN32
#define CXFopen _wfopen
#define __CXSTR_CAT(x)	L ## x
#define CXSTR(x)	__CXSTR_CAT(x)
