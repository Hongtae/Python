...
#ifdef _WIN32
#define CXSTRNCASECMP(a,b,c) _wcsnicmp(a,b,c)
#else
#define CXSTRNCASECMP(a,b,c) strncasecmp(a,b,c)
#endif
...
////////////////////////////////////////////////////////////////////////////////
uint32_t CxImage::GetTypeIdFromName(const CXCHAR* ext)
{
#if CXIMAGE_SUPPORT_BMP
	if (CXSTRNCASECMP(ext,CXSTR("bmp"),3)==0 )		return CXIMAGE_FORMAT_BMP;
#endif
#if CXIMAGE_SUPPORT_JPG
	if (CXSTRNCASECMP(ext,CXSTR("jpg"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("jpe"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("jfi"),3)==0 )		return CXIMAGE_FORMAT_JPG;
#endif
#if CXIMAGE_SUPPORT_GIF
	if (CXSTRNCASECMP(ext,CXSTR("gif"),3)==0 )		return CXIMAGE_FORMAT_GIF;
#endif
#if CXIMAGE_SUPPORT_PNG
	if (CXSTRNCASECMP(ext,CXSTR("png"),3)==0 )		return CXIMAGE_FORMAT_PNG;
#endif
#if CXIMAGE_SUPPORT_ICO
	if (CXSTRNCASECMP(ext,CXSTR("ico"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("cur"),3)==0 )		return CXIMAGE_FORMAT_ICO;
#endif
#if CXIMAGE_SUPPORT_TIF
	if (CXSTRNCASECMP(ext,CXSTR("tif"),3)==0 )		return CXIMAGE_FORMAT_TIF;
#endif
#if CXIMAGE_SUPPORT_TGA
	if (CXSTRNCASECMP(ext,CXSTR("tga"),3)==0 )		return CXIMAGE_FORMAT_TGA;
#endif
#if CXIMAGE_SUPPORT_PCX
	if (CXSTRNCASECMP(ext,CXSTR("pcx"),3)==0 )		return CXIMAGE_FORMAT_PCX;
#endif
#if CXIMAGE_SUPPORT_WBMP
	if (CXSTRNCASECMP(ext,CXSTR("wbm"),3)==0 )		return CXIMAGE_FORMAT_WBMP;
#endif
#if CXIMAGE_SUPPORT_WMF
	if (CXSTRNCASECMP(ext,CXSTR("wmf"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("emf"),3)==0 )		return CXIMAGE_FORMAT_WMF;
#endif
#if CXIMAGE_SUPPORT_JP2
	if (CXSTRNCASECMP(ext,CXSTR("jp2"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("j2k"),3)==0 )		return CXIMAGE_FORMAT_JP2;
#endif
#if CXIMAGE_SUPPORT_JPC
	if (CXSTRNCASECMP(ext,CXSTR("jpc"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("j2c"),3)==0 )		return CXIMAGE_FORMAT_JPC;
#endif
#if CXIMAGE_SUPPORT_PGX
	if (CXSTRNCASECMP(ext,CXSTR("pgx"),3)==0 )		return CXIMAGE_FORMAT_PGX;
#endif
#if CXIMAGE_SUPPORT_RAS
	if (CXSTRNCASECMP(ext,CXSTR("ras"),3)==0 )		return CXIMAGE_FORMAT_RAS;
#endif
#if CXIMAGE_SUPPORT_PNM
	if (CXSTRNCASECMP(ext,CXSTR("pnm"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("pgm"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("ppm"),3)==0 )		return CXIMAGE_FORMAT_PNM;
#endif
#if CXIMAGE_SUPPORT_JBG
	if (CXSTRNCASECMP(ext,CXSTR("jbg"),3)==0 )		return CXIMAGE_FORMAT_JBG;
#endif
#if CXIMAGE_SUPPORT_MNG
	if (CXSTRNCASECMP(ext,CXSTR("mng"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("jng"),3)==0 )		return CXIMAGE_FORMAT_MNG;
#endif
#if CXIMAGE_SUPPORT_SKA
	if (CXSTRNCASECMP(ext,CXSTR("ska"),3)==0 )		return CXIMAGE_FORMAT_SKA;
#endif
#if CXIMAGE_SUPPORT_PSD
	if (CXSTRNCASECMP(ext,CXSTR("psd"),3)==0 )		return CXIMAGE_FORMAT_PSD;
#endif
#if CXIMAGE_SUPPORT_RAW
	if (CXSTRNCASECMP(ext,CXSTR("nef"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("crw"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("cr2"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("dng"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("arw"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("erf"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("3fr"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("dcr"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("raw"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("x3f"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("mef"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("raf"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("mrw"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("pef"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("sr2"),3)==0 ||
		CXSTRNCASECMP(ext,CXSTR("orf"),3)==0 )		return CXIMAGE_FORMAT_RAW;
#endif
