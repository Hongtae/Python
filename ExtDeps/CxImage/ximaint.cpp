...
//	return(0.5f+0.5f*(float)cos(CX_PI*x));
}
////////////////////////////////////////////////////////////////////////////////
float CxImage::KernelHanning(const float x)
{
	if (fabs(x)>1) return 0.0f;
	return (0.5f+0.5f*(float)cos(CX_PI*x))*((float)sin(CX_PI*x)/(CX_PI*x));
}
////////////////////////////////////////////////////////////////////////////////
float CxImage::KernelHamming(const float x)
{
	...
	return 0.0f;
//	if (fabs(x)>1) return 0.0f;
//	return(0.54f+0.46f*(float)cos(CX_PI*x));
}
////////////////////////////////////////////////////////////////////////////////
float CxImage::KernelSinc(const float x)
{
	if (x == 0.0)
		return(1.0);
	return((float)sin(CX_PI*x)/(CX_PI*x));
}
////////////////////////////////////////////////////////////////////////////////
float CxImage::KernelBlackman(const float x)
{
	//if (fabs(x)>1) return 0.0f;
	return (0.42f+0.5f*(float)cos(CX_PI*x)+0.08f*(float)cos(2.0f*CX_PI*x));
}
////////////////////////////////////////////////////////////////////////////////
...
float CxImage::KernelBessel_Order1(float x)
{
	...
	q = (float)sqrt(2.0f/(CX_PI*x))*(float)(KernelBessel_P1(x)*(1.0f/sqrt(2.0f)*(sin(x)-cos(x)))-8.0f/x*KernelBessel_Q1(x)*
...
float CxImage::KernelBessel(const float x)
{
	if (x == 0.0f)
		return(CX_PI/4.0f);
	return(KernelBessel_Order1(CX_PI*x)/(2.0f*x));
}
////////////////////////////////////////////////////////////////////////////////
float CxImage::KernelGaussian(const float x)
{
	return (float)(exp(-2.0f*x*x)*0.79788456080287f/*sqrt(2.0f/CX_PI)*/);
}
////////////////////////////////////////////////////////////////////////////////
