...
//	bool Load(const CXCHAR * imageFileName){ return CxImage::Load(imageFileName,CXIMAGE_FORMAT_JPG);}
//	bool Save(const CXCHAR * imageFileName){ return CxImage::Save(imageFileName,CXIMAGE_FORMAT_JPG);}
...
protected:
    ...
    bool GetExifThumbnail(const CXCHAR *filename, const CXCHAR *outname, int32_t type);
