...
extern "C" {
#include "../libmng-1.0.10/libmng.h"
#include "../libmng-1.0.10/libmng_data.h"
#include "../libmng-1.0.10/libmng_error.h"
}
...
public:
	...
	bool Load(const CXCHAR * imageFileName);
	...
	bool Save(const CXCHAR * imageFileName){ return CxImage::Save(imageFileName,CXIMAGE_FORMAT_MNG);}
